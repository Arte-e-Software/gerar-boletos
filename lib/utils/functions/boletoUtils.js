...
const Bmpmoneyplus = require('../../boleto/bancos/bmpmoneyplus');
...
var Datas = (function() {
    ...
    Datas.prototype.comDocumento = function(_documento, locate = 'usa') {
        ...
        if (!validarData(_documento)) {
            throw new Error('O ano do documento deve ser maior que 1997 e menor que 2040');
        }
